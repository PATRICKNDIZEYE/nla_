        ...
        <aside className="bg-white inset-0 z-50 h-[calc(100vh)] transition-transform duration-300 xl:translate-x-0">
          ...
          <div className="ml-4">
            <ul className="mb-4 flex flex-col gap-1">
              ...
              <li>
                <Link onClick={onClose} className="" href="/dispute">
                  <button
                    className={`${
              ...
              >
                <Link onClick={onClose} className="" href="/report">
                  <button
                    className={`${
              ...
              <li>
                <Link onClick={onClose} className="" href="/invitations">
                  <button
                    className={`${
              ...
              >
                <Link onClick={onClose} className="" href="/users">
                  <button
                    className={`${
              ...
              >
                <Link onClick={onClose} className="" href="/logs">
                  <button
                    className={`${
...
export default LeftSideNavPopup;
